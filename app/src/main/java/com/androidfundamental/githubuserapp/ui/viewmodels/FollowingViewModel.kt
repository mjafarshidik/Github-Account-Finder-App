...
class FollowingViewModel(application: Application) : AndroidViewModel(application) {
    val listUserFollowing = MutableLiveData<ArrayList<UserResponse>>()

    internal fun getDataFollowing(): LiveData<ArrayList<UserResponse>> = listUserFollowing

    internal fun setDataFollowing(userLogin: String) {
            ...
            .get(" https://api.github.com/users/$userLogin/following", object :
                ...
                override fun onSuccess(
                    ...
                    try {
                        ...
                        listUserFollowing.postValue(listUser)
                    } catch (e: Exception) {
                        Toast.makeText(
                            getApplication(),
